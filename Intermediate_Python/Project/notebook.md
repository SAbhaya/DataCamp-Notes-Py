...
```
    ...
    <matplotlib.axes._subplots.AxesSubplot at 0x7f86e849e438>
...
plt.subplot(3, 1, 1)
plt.plot(x = tv['super_bowl'], y = tv['avg_us_viewers'], color= '#648FFF' )
plt.title('Average Number of US Viewers')

# Activate the middle subplot
plt.subplot(3, 1, 2)
plt.plot(x = tv['super_bowl'], y = tv['rating_household'], color='#DC267F')
plt.title('Household Rating')

# Activate the bottom subplot
plt.subplot(3, 1, 3)
plt.plot(x = tv['super_bowl'], y = tv['ad_cost'], color='#FFB000')
plt.title('Ad Cost')
